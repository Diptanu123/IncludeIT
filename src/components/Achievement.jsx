...
export default function Achievements() {
  ...
  return (
    <section className={`py-16 ${isDarkMode ? 'bg-gradient-to-b from-gray-900 to-gray-800 text-white' : 'bg-gradient-to-b from-blue-50 to-indigo-100 text-gray-900'}`}>
      <div className="container mx-auto px-6 md:px-12 lg:px-24">
        <h2 className={`text-4xl md:text-5xl font-extrabold text-center mb-12 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Our Achievements</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Achievement 1 */}
          <div className={`relative ${isDarkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-white hover:bg-gray-100'} rounded-xl shadow-xl p-8 text-center transition-transform transform hover:scale-105 group`}>
            ...
            <p className={`mt-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>We have successfully enrolled over 100 students across various technical domains.</p>
          </div>
          ...
          <div className={`relative ${isDarkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-white hover:bg-gray-100'} rounded-xl shadow-xl p-8 text-center transition-transform transform hover:scale-105 group`}>
            ...
            <p className={`mt-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>More than 50 students have secured placements in top companies.</p>
          </div>
          ...
          <div className={`relative ${isDarkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-white hover:bg-gray-100'} rounded-xl shadow-xl p-8 text-center transition-transform transform hover:scale-105 group`}>
            ...
            <p className={`mt-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Our students have achieved an impressive average package of 10 LPA.</p>
          </div>
          ...
          <div className={`relative ${isDarkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-white hover:bg-gray-100'} rounded-xl shadow-xl p-8 text-center transition-transform transform hover:scale-105 group`}>
            ...
            <p className={`mt-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>We collaborate with over 20 top industry partners to ensure high-quality education.</p>
          </div>
          ...
          <div className={`relative ${isDarkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-white hover:bg-gray-100'} rounded-xl shadow-xl p-8 text-center transition-transform transform hover:scale-105 group`}>
            ...
            <p className={`mt-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Our curriculum includes globally recognized certifications.</p>
          </div>
        </div>
      </div>
      ...
      <button
        ...
        className="absolute top-4 right-4 px-4 py-2 bg-indigo-600 text-white rounded-full"
      >
        Toggle Mode
      </button>
    </section>
