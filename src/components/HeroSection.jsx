...
export default function HeroSection() {
  return (
    <div
      id="home"
      className="relative bg-gradient-to-r from-blue-50 to-indigo-100 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center py-16 lg:py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full lg:w-1/2 mb-12 lg:mb-0 text-center lg:text-left">
          <h1 className="text-5xl font-extrabold text-gray-900 sm:text-6xl lg:text-7xl leading-tight">
            “An Institute with <span className="text-indigo-600">NITians</span>{" "}
            by <span className="text-indigo-600">NITians</span>”
          </h1>
          ...
          <p className="mt-4 text-sm text-gray-500">
            Join over <strong>100+</strong> students who have transformed their
            careers with us.
          </p>
        </div>

        {/* Image Section */}
        <div className="w-full lg:w-1/2 flex justify-center relative lg:pl-8">
          <div className="relative group">
            ...
            <div className="absolute bottom-4 left-4 text-white">
              ...
              <p className="text-sm">
                Personalized coaching tailored for your success.
              </p>
            </div>
          </div>
        </div>
